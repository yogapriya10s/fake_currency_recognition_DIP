clear all;
close all;
Ireal = imread('https://tse2.mm.bing.net/th?id=OIP._aww1hSp1shpl__3S5AgJgHaEK&pid=Api&P=0&h=180'); % Real
Iscaned = imread('https://tse3.mm.bing.net/th?id=OIP.S4c7tDyVG_yXiZP3o1BnZwHaDS&pid=Api&P=0&h=180'); % scaned
%%//Pre-analysis
...
blackStripReal = Ireal(:,200:320,:);
blackStripscaned = Iscaned(:,200:320,:);
